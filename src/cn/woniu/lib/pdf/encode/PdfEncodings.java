...
import cn.woniu.lib.pdf.font.BaseFont;
import cn.woniu.lib.pdf.model.PDFObj;


/** 
 * @ClassName: PdfEncodings <br/> 
 * @Description: 参考iTextPDF  <br/> 
 * 
 * @since JDK 1.6 
 */
public class PdfEncodings {
    static final char winansiByteToChar[] = {
        ...
        public static final byte[] convertToBytes(String text, String encoding) {
            ...
            else if (encoding.equals(PDFObj.TEXT_PDFDOCENCODING)) {
                hash = pdfEncoding;
            }
            if (hash != null) {
            ...
            if (encoding.equals(PDFObj.TEXT_UNICODE)) {
